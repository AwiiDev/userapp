                ...
                Form(
                  ...
                  child: CustomTextField(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: (widget.flagImage.isNotEmpty)
                                    ? DecorationImage(
                                    image: NetworkImage(widget.flagImage),
                                    fit: BoxFit.fill)
                                    : null,
                              ),
                            ),
                    ...
                    validator: (value) {
                      ...
                      // ✅ Vérification mobile spécifique Algérie
                      if (widget.dialCode == "+213") {
                        // doit commencer par 0 puis 5/6/7 et avoir exactement 10 chiffres
                        final algerianRegex = RegExp(r'^0[567]\d{8}$');
                        if (!algerianRegex.hasMatch(value)) {
                          return "Ex : 0550 12 34 56";
                        }
                        return null;
                      }

                      // ✅ Vérification mobile générique pour les autres pays
                      if (AppValidation.mobileNumberValidate(value)) {
                        return null;
                      }
