...
class UpdateVehicleMakeEvent extends DriverProfileEvent {
  final int id;
  UpdateVehicleMakeEvent({required this.id});
}

class UpdateVehicleModelEvent extends DriverProfileEvent {
  final int id;
  UpdateVehicleModelEvent({required this.id});
}

class UpdateVehicleColorEvent extends DriverProfileEvent {
  final int id;
  UpdateVehicleColorEvent({required this.id});
}
