...
class BiddingRequestWidget extends StatelessWidget {
  ...
  BiddingRequestWidget({super.key, required this.cont});
    ...
    return BlocProvider.value(
      ...
      child: BlocBuilder<HomeBloc, HomeState>(
        builder: (context, state) {
          ...
          var goods = context.read<HomeBloc>().rideList.firstWhere((e) => e['request_id'] == context.read<HomeBloc>().choosenRide)['goods'];
          try {
            goods = jsonDecode(goods);
          } catch(e) {
                    ...
                    Column(
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              ...List.generate(goods.length, (i) {
                                return Padding(
                                  padding: const EdgeInsets.only(right: 5.0),
                                  child: ClipRRect(
                                      borderRadius: BorderRadius.circular(5),
                                      child: Image.network('${AppConstants.baseUrl}/storage/${goods[i]}', height: 60, width: 60, fit: BoxFit.cover)),
                                );
                              }),
                              const Spacer(),
                                ...
                                showDialog(context: context, builder: (_) => Dialog(
                                  child: SizedBox(
                                    ...
                                    child: PageView.builder(
                                        ...
                                        itemCount: goods.length, itemBuilder: (_, index) {
                                      return Stack(
                                        children: [
                                          Image.network('${AppConstants.baseUrl}/storage/${goods[index]}', height: size.height, width: size.width, fit: BoxFit.cover,),
                                          Positioned(
                                              right: 0,
                                              top: 0,
                                              bottom: 0,
