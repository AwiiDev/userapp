            ...
            showDialog(
              ...
              builder: (cc) {
                return CustomSingleButtonDialoge(
                  ...
                  onTap: () {
                    Navigator.pop(cc);
                    context.read<HomeBloc>().showGetDropAddress = true;
                    context.read<HomeBloc>().polylist.clear();
                    context.read<HomeBloc>().polyline.clear();
                    context.read<HomeBloc>().fmpoly.clear();
                    context.read<HomeBloc>().markers.removeWhere((element) =>
