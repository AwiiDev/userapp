...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Your documents are under review.Approval will be given soon as possible Please wait to start your earnings.!'**
...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'az', 'en', 'es', 'fr'].contains(locale.languageCode);
